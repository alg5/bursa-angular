    ...
    ***************************************************************************** */
    ...
    var MatSelectSearchComponent = /** @class */ (function () {
        ...
        MatSelectSearchComponent.prototype.initMultiSelectedValuesTracking = function () {
            var _this = this;
            this._formControl.valueChanges.pipe(operators.startWith(undefined), operators.scan(function (acc, currentValue) { return ({ currentValue: currentValue, previousValue: acc.currentValue }); }, ({ currentValue: undefined, previousValue: undefined })), operators.takeUntil(this._onDestroy)).subscribe(function (value) {
